									...
									<div class="card-body">
										<form class="form-horizontal form-bordered" method="POST" action="{{route('home-content.update', $home_content)}}" enctype="multipart/form-data">
											...
											<div class="form-group row">
												...
												<div class="col-lg-8">
													<textarea class="form-control" id="summary-ckeditor" name="message" rows="20">{{$home_content->body}}</textarea>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Replace Homepage Image</label>
												<div class="col-lg-8">
